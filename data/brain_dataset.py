...
class brain_train(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.align:
            ...
            ref_GT_img_path = self.GT_paths[idx].replace('T2', 'T1_noalign')
            # ref_GT_img_path = self.GT_paths[idx].replace('T2_test', 'T1_test_non_rigid')

        if self.task == 'sr':
            if self.scale == 2:
                mask_path = '/data3/lpc/dataset/BrainTS/mask_sr_x2.png'
            elif self.scale == 4:
                mask_path = '/data3/lpc/dataset/BrainTS/mask_sr_x4.png'
            elif self.scale == 8:
                mask_path = '/data3/lpc/dataset/BrainTS/mask_sr_x8.png'
            else:

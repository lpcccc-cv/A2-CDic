...
class knee_train(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.align == True:
            ...
            ref_GT_img_path = self.GT_paths[idx].replace('PDFS', 'PD_noalign')
        
        if self.task == 'sr':
            if self.scale == 2:
                mask_path = 'mask_sr_x2.png'
            elif self.scale == 4:
                mask_path = 'mask_sr_x4.png'
            elif self.scale == 8:
                mask_path = 'mask_sr_x8.png'
            else:
        ...
        im1_GT = cv2.resize(im1_GT, (256,256))
        im2_GT = cv2.resize(im2_GT, (256,256))
